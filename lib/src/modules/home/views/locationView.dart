...
class LocationView extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    print("${controller.userSaveAddress.value.addressDetails?.length}");
    return Scaffold(
      body: Obx(
        () => Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                // controller.userSaveAddress.map(

                // controller.userSaveAddressData.asMap().entries
                //                 .map((entry) {
                //               int index = entry.key;
