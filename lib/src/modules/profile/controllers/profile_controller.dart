...
class ProfileController extends BaseController<ProfileRepository> {
  ...
  String getUserFullName() {
    String fullName = userDetailsData.data?.fullName ?? '';
  ...
  void loadProfileDetails() async {
    ...
    emailTextController.text = userDetails.value.data?.email ?? '';
    mobileTextController.text = userDetails.value.data?.mobile ?? '';

    dobTextController.text =
        FormatHelper.formatDateOfBirthToIST(userDetails.value.data?.dob);
    genderValue = userDetails.value.data?.gender ?? '';
    addressTextController.text =
        userDetails.value.data?.addressDetails?.first.address ?? '';
    cityTextController.text =
        userDetails.value.data?.addressDetails?.first.city ?? '';
    pincodeTextController.text =
        userDetails.value.data?.addressDetails?.first.pincode ?? '';
    stateTextController.text =
        userDetails.value.data?.addressDetails?.first.state ?? '';
