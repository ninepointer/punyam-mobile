...
class AllMandirSearchView extends GetView<MandirController> {
  const AllMandirSearchView({Key? key}) : super(key: key);
                ...
                child: Column(
                  children: [
                    ...
                    controller.nearbyMandirsSearch.isEmpty
                        ? NoDataFound()
                        : Column(
                            children: controller.nearbyMandirsSearch
                                .map((templeDetails) {
